  ...
  return (
    <div className="p-6  md:p-2 border-2 border-[#c084fc] rounded shadow-md text-center ">
      <img
        ...
        alt="img"
      />
      <h1 className="font-semibold text-3xl pt-4">{enginee.name}</h1>

      <div className="flex justify-center gap-4">
        <p className=" pt-1 text-xl">{enginee.job_title}</p>
        <p className=" pt-1 text-xl">Exp : {enginee.experience} +</p>
      </div>
